        ...
        {isMenuOpen && (
          <div className="bg-white border-t shadow-lg">
            <div className="px-4 py-6 space-y-4">
              ...
              <a href="tel:+905551234567" className="flex items-center space-x-2 text-gray-700 py-2 mt-2">
              ...
              <Link href="/quote" onClick={() => setIsMenuOpen(false)}>
                <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white text-lg py-3 mt-2">Randevu Al</Button>
              </Link>
            </div>
          </div>
        )}
      ...
      <header className="fixed top-0 w-full bg-white shadow-md z-50 border-b transition-shadow">
        <div className="flex justify-between items-center h-28 px-4">
          ...
          <div className="flex items-center space-x-4">
            <a href="tel:+905551234567" className="hidden sm:flex items-center space-x-2 text-gray-700 font-semibold">
              <Phone className="w-5 h-5 text-blue-600" />
              <span>İletişim</span>
            </a>
            <Link href="/quote">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 text-base font-bold shadow-md">Randevu Al</Button>
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-28">
          ...
          <div className="flex items-center space-x-6 min-w-[260px] justify-end">
            <a href="tel:+905551234567" className="flex flex-col items-end group hover:text-blue-600 transition-colors min-w-[140px]">
            ...
            <Link href="/quote">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 text-lg font-bold shadow-md">Randevu Al</Button>
            </Link>
          </div>
        </div>
      </div>
