      ...
      <section className="py-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-blue-600 text-white rounded-2xl shadow-lg p-8 flex flex-col items-center justify-center">
            <h3 className="text-2xl font-bold mb-4">Neden Detaylı Teklif Almalısınız?</h3>
            <ul className="space-y-3 text-base">
              <li>✔ Net ve şeffaf fiyatlandırma</li>
              <li>✔ TV'nize özel çözüm ve teşhis</li>
              <li>✔ Gereksiz masraf ve zaman kaybı önlenir</li>
              <li>✔ 12 ay garanti ve uzman desteği</li>
            </ul>
          </div>
        </div>
      </section>
